...
void run_mha_fwd_splitkv_mla(Flash_fwd_params &params, hggcStream_t stream);
...
template<typename T, int Headdim, int Headdim_V> void run_mha_fwd_splithd_splitkv_dispatch(Flash_fwd_params &params, hggcStream_t stream);

template<typename T> void run_sparse_prefill_fwd_dispatch(SparsePrefillParams &params);

template<typename T, bool IsFP8, int Headdim, int Headdim_V> void run_sparse_decode_fwd_dispatch(Flash_fwd_params &params, hggcStream_t stream);