...
struct Traits {
    ...
    // static constexpr int AtomLayout = 4;
    ...
    //     MMA_Atom_Arch,
    //     Layout<Shape<Int<AtomLayout>, Int<4/AtomLayout>, _1>>,
    //     Tile<Int<16 * AtomLayout>, Int<16 * 4 / AtomLayout>, _16>>;
    using TiledMma = TiledMMA<
        MMA_Atom_Arch,
    ...
    using SmemCopyAtomP = Copy_Atom<SM75_U32x4_LDSM_N, InputT>;
