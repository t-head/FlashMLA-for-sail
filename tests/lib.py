...
def generate_testcase(t: TestParam) -> Testcase:
    ...
    # q = torch.ones((t.s_q, t.h_q, t.d_qk), dtype=torch.bfloat16)
    # kv = torch.ones((t.s_kv, t.h_kv, t.d_qk), dtype=torch.bfloat16)
    # do = torch.ones((t.s_q, t.h_q, t.d_v), dtype=torch.bfloat16)
    ...
    # indices = torch.full((t.s_q, t.h_kv, t.topk), t.s_kv, dtype=torch.int32)
    ...
    if t.is_all_indices_invalid:
        ...
        # print(all_indices_invalid_mask)
